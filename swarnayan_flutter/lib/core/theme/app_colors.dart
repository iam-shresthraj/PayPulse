...
class AppColors {
  ...
  // ── Primary (PayPulse Red #7D0202) ──
  static Color get primary => const Color(0xFF7D0202);
  static Color get primaryLight => const Color(0xFF9C0A0A);
  static Color get primaryDark => const Color(0xFF5A0101);
  static Color get primaryContainer => isLight ? const Color(0xFFFDE8E9) : const Color(0xFF2E0101);
