  ...
  Future<void> _generateInvoice() async {
    ...
    try {
      ...
      final invoice = Invoice(
        ...
        tempCustomerName: customer.name,
        tempCustomerMobile: customer.mobile,
        tempCustomerAddress: customer.address,
        tempCustomerPincode: customer.pincode,
        tempCustomerCity: customer.city,
        tempCustomerState: customer.state,
        items: invoiceItems,
